[unititled2.css](https://github.com/user-attachments/files/23526865/unititled2.css)
:root {
    --s: 2s;
    --d: 40;
    --c: #ff6600;
...
.sphere div {
    ...
    animation: shine var(--s) linear var(--dl)
    infinite;
    background: #fff0;
    display: flex;
    align-items: center;
...
.sphere div::before {
    ...
    position: absolute;
    border: 0.25vmin solid var(--c),
    0 0 0.5vmin 0.5vmin var(--c) linear calc(var(--dl) * -1) infinite;
}
...
@keyframes shine {
    50%, 100% {
        ...
        box-shadow: 0 0 1px 1px #10101000,
        0 0 1px 1px #10101000 inset;
        filter: hue-rotate(540deg);
    }
}

@keyframes spin {
    0% { transform: rotate(-210deg) rotateY(0deg) rotatez(185deg); }
